/**
 * Classic Tab Menu - JavaScript Features
 * Self-contained functionality for the Classic tab menu style
 */
...
(function() {
    ...
    /**
     * Initialize Classic tab menu features
     */
    function initClassicTabMenu() {
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initClassicTabMenu);
    } else {
        initClassicTabMenu();
    }

    // Expose functions globally if needed
    window.ClassicTabMenu = {
        init: initClassicTabMenu,
